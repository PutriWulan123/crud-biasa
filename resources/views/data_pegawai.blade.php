                ...
                <table class="table table-responsive-md table-hover" id="table-pegawai">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Id Devisi</th>
                  ...
                  {{-- {{ dd($row) }} --}}
                    <tr class="text">
                      ...
                      {{-- <td>{{ $row->pegawai->devisi->nama_devisi }}</td> --}}
                      <td>{{ $row->id_devisi}}</td>
                      <td>{{ $row->alamat}}</td>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <form action="/updatedata_pegawai/{{$row->id}}" method="POST" 
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label">Id Devisi</label>
                                      <input type="text" name="id_devisi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="{{ $row->id_devisi}}">
                                  </div>
                                  <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label">Alamat</label>
                                  ...
                                  <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label">No.Telp</label>
                                      <input type="number" name="no_telp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="{{ $row->notelp}}">
                                 </div>
                                </div> 
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Keluar</button>
